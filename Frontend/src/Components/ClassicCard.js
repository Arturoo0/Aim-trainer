    ...
    return (
        <div id="classic-card" className="card">
          <div className="card-body">
            ...
            <p id="classic-card-text" className="card-text">5 lives to take out as many targets as you can. Targets progressively have smaller hit windows and start appearing more frequently.</p>
